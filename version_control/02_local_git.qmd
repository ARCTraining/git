---
title: "2. Basic git cycle"
subtitle: "Learning the basic git cycle"
format:
    html:
...
[Open introduction presentation ↗](02_presentation.qmd){.btn .btn-outline-primary .btn role="button" data-toggle="tooltip" title="Open presentation in a new tab" target="_blank"}
...
result = include_and_convert('_02_content.qmd')
print(result)
```
